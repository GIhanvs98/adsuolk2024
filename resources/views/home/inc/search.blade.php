...
@if (isset($enableFormAreaCustomization) && $enableFormAreaCustomization == '1')
	...
	<!-- start hero-section -->@extends('layouts.layout')
...
<!--	<div class="hero-area">
	...
	<div class="intro{{ $hideOnMobile }}{{ $parallax }}"style="margin-top:0">
		<div class="container text-center ">
			...
			@if ($hideForm != '1')
					...
					<div class="categories-title text-center">
						...
						<p style="letter-spacing: 0.1px; ; jfont-size: 10px;;" class="search-bar-text">Welcome to Adsup.lk! Revolutionize your online market experience in Sri Lanka. Buy, sell, or search for cars, phones, property, jobs, and more. Enjoy lifetime free ads!</p>
						<style>
							h4{
									margin-top: 10px;
									font-weight: 700;
