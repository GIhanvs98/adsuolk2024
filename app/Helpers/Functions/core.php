...
function genPhoneNumberBtn($post, bool $btnBlock = false): string
{
	...
	$enableWhatsAppBtn = (config('settings.listing_page.enable_whatsapp_btn') == 1);
	$whatsAppPreFilledMessage = (config('settings.listing_page.pre_filled_whatsapp_message') == 1)
