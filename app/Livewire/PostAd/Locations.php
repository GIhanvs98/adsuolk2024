...
class Locations extends Component
{
    ...
    {
        $this->districts = SubAdmin2::where('active', 1)->withWhereHas('cities', function ($query) { $query->orderBy('id', 'asc'); })->orderBy('id', 'asc')->get();
    ...
    public function showCities(string $districtId){
        ...
        $this->cities = $this->selectedDistrict->cities()->orderBy('id', 'asc')->get();
